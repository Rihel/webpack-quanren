...
var loginBox = $('.login');
var username = loginBox.find('#mobile');
var password = loginBox.find('#pwd');
username.val(_until2.default.getItem('mobile') || '');

username.on('change', function () {
    var name = username.val();
    if (!_until2.default.isPhone(name)) {
...
$('.login-btn').on('click', function () {
    ...
    if (name === '' || pwd === '') {
        (0, _dialog.alert)('用户名或者密码不能为空');
        return;
    }

    (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
        var _ref2, _status, data;
            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        _context.prev = 0;
                        _context.next = 3;
                        return (0, _api.user_Status)(name);
                    ...
                    case 7:
                        ...
                        (0, _dialog.alert)(_context.t0.errorDetail.msg);

                    case 10:
                        _until2.default.setItem('mobile', name);
                    ...
                    case 15:
                        _context.prev = 15;
                        _context.next = 18;
                        return (0, _api.login)(name, pwd);

                    case 18:
                        data = _context.sent;

                        if (status === 7) {
                            _until2.default.jumpPage('index', {
                                p: name
                            });
                            if (status === 9) {
                                _until2.default.jumpPage('notify_bind_wx');
                            }
                        }
                        _context.next = 26;
                        break;
                    ...
                    case 22:
                        ...
                        (0, _dialog.alert)(_context.t1.errorDetail.msg);
    ...
    function tips(mes, jumpPage, data) {
        ...
        (0, _dialog.dialog)({
            ...
            btnsCallback: function btnsCallback(btns) {
                if (arg.length > 1) {
                    $(btns).click(function () {
                        _until2.default.jumpPage(jumpPage, data);
                    });
                }
            }
        });
    ...
    var hander = {
        ...
        4: function _() {
            tips(message[status], 'notify_pre_validation02', {
                p: _until2.default.getItem('mobile')
            });
        },
        5: function _() {
            tips(message[status], 'notify_pre_validation02', {
